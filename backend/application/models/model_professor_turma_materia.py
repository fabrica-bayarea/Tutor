...
class ProfessorTurmaMateria(db.Model):
    ...
    professor_id = db.Column(db.UUID(as_uuid=True), db.ForeignKey('usuario.id'), nullable=False, primary_key=True)
    ...
    professor = db.relationship('Usuario', back_populates='turmas_materias')
